...
This set up is **mandatory** to continue adding services, as this "adds" the f5 to the SDN of the kubernetes cluster.

Another option might be the implementation via NodePort (not part of this lab - as this set up is not as sophisticated as Cluster IP set up.
